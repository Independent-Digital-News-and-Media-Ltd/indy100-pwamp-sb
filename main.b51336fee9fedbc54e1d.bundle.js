...
`,LiveCapsule=({className:className,status:status,updated:updated})=>{const statusLiveText=status?"LIVE":"AS IT HAPPENED",statusUpdatedText=status?"Updated":"Ended",StyledWrapper=status?WrapperLive:WrapperClosed;return Object(jsx_runtime.jsxs)(StyledWrapper,{className:className,children:[Object(jsx_runtime.jsx)(StyledIcon,{}),Object(jsx_runtime.jsx)(LiveText,{children:statusLiveText}),Object(jsx_runtime.jsxs)(UpdateTime,{children:[Object(jsx_runtime.jsx)(UpdatedText,{children:statusUpdatedText}),Object(jsx_runtime.jsx)("amp-timeago",{height:"16",layout:"fixed-height",datetime:moment_default.a.unix(updated).toISOString(),locale:"en",children:updated})]})]})};LiveCapsule.propTypes={className:prop_types_default.a.string,status:prop_types_default.a.number.isRequired,updated:prop_types_default.a.number.isRequired},LiveCapsule.__docgenInfo={description:"",methods:[],displayName:"LiveCapsule",props:{className:{type:{name:"string"},required:!1,description:""},status:{type:{name:"number"},required:!0,description:""},updated:{type:{name:"number"},required:!0,description:""}}};var Article_LiveCapsule=LiveCapsule;"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["app/component/library/Article/LiveCapsule.js"]={name:"LiveCapsule",docgenInfo:LiveCapsule.__docgenInfo,path:"app/component/library/Article/LiveCapsule.js"});const Header_Wrapper=styled_components_browser_esm.default.header``,Header=Object(styled_components_browser_esm.default)(props=>{const{className:className,article:article,article:{title:title,hero:hero,isLiveBlog:isLiveBlog}}=props;return Object(jsx_runtime.jsxs)(Header_Wrapper,{className:className,children:[isLiveBlog&&Object(jsx_runtime.jsx)(Article_LiveCapsule,{status:article.liveblog.data.status,updated:Object(helper.getLatestUpdateTime)(article)}),Object(jsx_runtime.jsx)(Article_Headline,{children:title}),Object(jsx_runtime.jsx)(Article_ArticleMeta,{}),Object(jsx_runtime.jsx)(Article_Hero,{hero:hero})]})})`
  ...
  flex-direction: column;
  text-align: center;
`;Header.propTypes={className:prop_types_default.a.string,article:prop_types_default.a.object.isRequired};var Article_Header=Header,ColumnWrapper=__webpack_require__(264),MarkupAd=__webpack_require__(150),Dugout=__webpack_require__(679),Dugout_default=__webpack_require__.n(Dugout);const VideoCaption_Caption=Object(styled_components_browser_esm.default)(({className:className,children:children})=>Object(jsx_runtime.jsx)("div",{className:className,children:children}))`
