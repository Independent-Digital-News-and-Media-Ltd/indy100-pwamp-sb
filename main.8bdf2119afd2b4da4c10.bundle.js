...
`,SectionContent=({components:components,theme:theme,configuration:configuration,section:section})=>{const currentSection=section.section,insert=(section=>{switch(section.type){case"author":return Object(jsx_runtime.jsx)(Author_AuthorRow,{author:section.section});default:return null}})(section),isWishlist="/wishlist"===currentSection.path,isHomePage="/"===currentSection.path;return Object(jsx_runtime.jsxs)(Content_Wrapper,{className:"section-content",children:[!isWishlist&&!isHomePage&&Object(jsx_runtime.jsx)(SectionTitle,{id:"section-title",children:currentSection.name}),insert,null==components?void 0:components.filter(skipComponentHasNoArticle).map((comp,i)=>{const Component=componentMap[comp.type],key=`${comp.type}${i}`;switch(comp.type){case"Title":case"ArticleX1":case"ArticleX2":case"ArticleX3":case"ArticleX8":return Object(jsx_runtime.jsx)(Component,{componentStyle:theme,data:comp,configuration:configuration},key);default:return Object(jsx_runtime.jsxs)("p",{style:{color:"red"},children:["Undefined component: ",comp.type]},"undefined"+i)}})]})};SectionContent.propTypes={components:prop_types_default.a.array,configuration:prop_types_default.a.object.isRequired,theme:prop_types_default.a.any,section:prop_types_default.a.object.isRequired,isWishlist:prop_types_default.a.bool},SectionContent.__docgenInfo={description:"",methods:[],displayName:"SectionContent",props:{components:{type:{name:"array"},required:!1,description:""},configuration:{type:{name:"object"},required:!0,description:""},theme:{type:{name:"any"},required:!1,description:""},section:{type:{name:"object"},required:!0,description:""},isWishlist:{type:{name:"bool"},required:!1,description:""}}};var Section_Content=SectionContent;"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["app/component/pages/Section/Content.js"]={name:"SectionContent",docgenInfo:SectionContent.__docgenInfo,path:"app/component/pages/Section/Content.js"});var page=__webpack_require__(169);const Section=props=>{const{className:className,section:section,menu:menu,configuration:configuration,cleanAmp:cleanAmp,structuredData:structuredData}=props,domain=configuration.domain,currentSection=section.section;return Object(jsx_runtime.jsxs)(Frame.a,{domain:domain,configuration:configuration,menu:menu,className:className,children:[Object(jsx_runtime.jsxs)(Helmet.Helmet,{children:[Object(jsx_runtime.jsx)("title",{children:Object(page.a)({section:section},configuration.name)}),structuredData&&Object.values(structuredData).filter(Boolean).map((json,index)=>Object(jsx_runtime.jsx)("script",{type:"application/ld+json",children:JSON.stringify(json)},index)),Object(jsx_runtime.jsx)("link",{rel:"alternate",href:configuration.baseUrl+("/"===currentSection.path?"/rss":currentSection.path+"/rss"),title:"RSS",type:"application/rss+xml"}),Object(jsx_runtime.jsx)("script",{async:!0,"custom-element":"amp-timeago",src:"https://cdn.ampproject.org/v0/amp-timeago-0.1.js"})]}),Object(jsx_runtime.jsx)(Head_SectionMeta,{section:section}),Object(jsx_runtime.jsx)(WallPaper.a,{id:"adSlotWallpaper"}),Object(jsx_runtime.jsx)(WallPaper.a,{id:"nativeBanner"}),Object(jsx_runtime.jsxs)(ColumnWrapper.a,{children:[Object(jsx_runtime.jsx)(Section_Content,{components:section.components,configuration:configuration,section:section}),section.sidebar&&Object(jsx_runtime.jsx)(library_Sidebar,{sidebar:section.sidebar})]}),Object(jsx_runtime.jsx)(StickyFooter.a,{cleanAmp:cleanAmp})]})};Section.propTypes={className:prop_types_default.a.string,section:prop_types_default.a.object.isRequired,menu:prop_types_default.a.object.isRequired,configuration:prop_types_default.a.object.isRequired,req:prop_types_default.a.object.isRequired,cleanAmp:prop_types_default.a.bool,structuredData:prop_types_default.a.object};__webpack_exports__.default=Object(styled_components_browser_esm.default)(Object(RequestProvider.withRequest)(Section))`
  display: flex;
  justify-content: center;
`},1309:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var prop_types=__webpack_require__(2),prop_types_default=__webpack_require__.n(prop_types),styled_components_browser_esm=__webpack_require__(3),Helmet=__webpack_require__(42),RequestProvider=__webpack_require__(11),Frame=__webpack_require__(129),Styles=__webpack_require__(5),postCodePatterns=__webpack_require__(271),FormSelect=__webpack_require__(152),FormTextField=__webpack_require__(64),FormSubmit=__webpack_require__(128),jsx_runtime=__webpack_require__(0);const Wrapper=styled_components_browser_esm.default.div`
  font-family: ${props=>props.theme.fontFamily.primaryFont};
